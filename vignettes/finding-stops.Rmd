...
Some aggregate endpoints (like `tm_aggregate_travel_times()`) take a **place
ID** instead of a stop ID. Place IDs refer to a whole station, not a platform.
...
CR stations have proper GTFS place IDs (unlike bus or ferry). Use these with
