...
> **Note:** Code in this vignette is not run automatically — copy and run it
> in your own R session after loading the package.
...
station has separate IDs for each direction (northbound toward Alewife = `0`,
southbound = `1`).
